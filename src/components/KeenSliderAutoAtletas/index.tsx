  ...
  return (
    <div ref={sliderRef} className="keen-slider">
      <div className="keen-slider__slide number-slide1">
        <span className={`w-full h-96 flex text-left justify-between xl:justify-center items-center gap-3 rounded-lg border-none outline-none bg-sky-500/80`}>
      ...
      <div className="keen-slider__slide number-slide8">
        <span className={`w-full h-96 flex text-left justify-between xl:justify-center items-center gap-3 rounded-lg border-none outline-none bg-sky-500/80`}>
          ...
          <div className={`flex flex-col justify-center items-center`}>
            <span className={`text-lg xl:text-xl 2xl:text-2xl font-pt-mono text-zinc-100`}>Heitor Gomes Dantas Lima</span>
